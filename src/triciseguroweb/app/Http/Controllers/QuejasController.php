...
class QuejasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            $quejas = Queja::where('nombre', 'LIKE', "%$keyword%")
                ->orWhere('taxista', 'LIKE', "%$keyword%")
                ->orWhere('descripcion', 'LIKE', "%$keyword%")
                ->latest()->paginate($perPage);
        } else {
            $quejas = Queja::latest()->paginate($perPage);
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('quejas')->with('flash_message', 'Queja added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('quejas')->with('flash_message', 'Queja updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('quejas')->with('flash_message', 'Queja deleted!');
    }
}
