                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Marca</th><th>Modelo</th><th>Matricula</th><th>placa_id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($taxis as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->marca }}</td><td>{{ $item->modelo }}</td><td>{{ $item->matricula }}</td><td>{{ $item->placa_id }}</td>
                                        <td>
