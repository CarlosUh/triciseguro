                            ...
                            <table class="table">
                                ...
                                @foreach($documento as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/documento/' . $item->id) }}" title="View Documento"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/documento/' . $item->id . '/edit') }}" title="Edit Documento"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
