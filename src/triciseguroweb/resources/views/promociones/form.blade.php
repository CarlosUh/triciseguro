...
<div class="form-group {{ $errors->has('fecha') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="fecha" type="datetime-local" id="fecha" value="{{ isset($promocione->fecha) ? $promocione->fecha : ''}}" >
...
<div class="form-group {{ $errors->has('tipo_promocion') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="tipo_promocion" type="textarea" id="tipo_promocion" >{{ isset($promocione->tipo_promocion) ? $promocione->tipo_promocion : ''}}</textarea>
