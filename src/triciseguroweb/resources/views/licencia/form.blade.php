<div class="form-group {{ $errors->has('nacionalidad') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nacionalidad" type="text" id="nacionalidad" value="{{ isset($licencia->nacionalidad) ? $licencia->nacionalidad : ''}}" required>
...
<div class="form-group {{ $errors->has('fecha_expedicion') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="fecha_expedicion" type="date" id="fecha_expedicion" value="{{ isset($licencia->fecha_expedicion) ? $licencia->fecha_expedicion : ''}}" required>
...
<div class="form-group {{ $errors->has('fecha_vencimiento') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="fecha_vencimiento" type="date" id="fecha_vencimiento" value="{{ isset($licencia->fecha_vencimiento) ? $licencia->fecha_vencimiento : ''}}" required>
