                            ...
                            <table class="table">
                                ...
                                @foreach($servicio as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/servicio/' . $item->id) }}" title="View Servicio"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/servicio/' . $item->id . '/edit') }}" title="Edit Servicio"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
