<div class="form-group {{ $errors->has('taxista') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control"  name="taxista" type="textarea" id="taxista" >{{ isset($calificacione->taxista) ? $calificacione->taxista : ''}}</textarea>
...
<div class="form-group {{ $errors->has('servicio') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control"  name="servicio" type="textarea" id="servicio" >{{ isset($calificacione->servicio) ? $calificacione->servicio : ''}}</textarea>
...
<div class="form-group {{ $errors->has('calificacion') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" name="calificacion" type="textarea" id="calificacion" >{{ isset($calificacione->calificacion) ? $calificacione->calificacion : ''}}</textarea>
