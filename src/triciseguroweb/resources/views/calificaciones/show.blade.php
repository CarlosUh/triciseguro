                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Taxista </th><td> {{ $calificacione->taxista }} </td></tr><tr><th> Servicio </th><td> {{ $calificacione->servicio }} </td></tr><tr><th> Calificacion </th><td> {{ $calificacione->calificacion }} </td></tr>
                                </tbody>
                            </table>
                        </div>
