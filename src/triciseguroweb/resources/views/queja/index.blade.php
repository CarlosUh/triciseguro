                            ...
                            <table class="table">
                                ...
                                @foreach($queja as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/queja/' . $item->id) }}" title="View Queja"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/queja/' . $item->id . '/edit') }}" title="Edit Queja"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
