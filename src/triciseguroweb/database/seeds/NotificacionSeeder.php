    ...
    public function run()
    {
      //Creacion del taxista
        ...
        $pasajero=factory(App\Persona::class)
          ...
          $notificacion->tipo='viaje';
          $notificacion->mensaje='necesito un viaje al parque del centro';
          $notificacion->origen()->associate($taxista);
          $notificacion->destino()->associate($pasajero);
          //guardar la solicitud
           $notificacion->save();
